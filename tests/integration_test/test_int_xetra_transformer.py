...
class IntegrationTestXetraETLMethods(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-integrate-test-src'
        self.s3_bucket_name_trg = 'xetra-integrate-test-trg'
