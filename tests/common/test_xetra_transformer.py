...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def test_extract_no_files(self):
        ...
        extract_date_list = []
        # Method execution
        # !! patch the MetaProcess class's return_date_list method inside XetraETL,
        # with the return value we define previously.
        # i.e., running inside instance xetra_etl, the MetaProcess.return_date_list method
        # returns the value we set up
    ...
    def test_extract_files(self):
        ...
        extract_date_lsit = ['2021-04-16', '2021-04-17', '2021-04-18', 
                              '2021-04-19']
        # Method execution
        with patch.object(MetaProcess, 'return_date_list',
        return_value=[extract_date, extract_date_lsit]):
            xetra_etl = XetraETL(self.s3_bucket_src, self.s3_bucket_trg,
                          self.meta_key, self.source_config, self.target_config)
            df_return = xetra_etl.extract()
        # Test after method execution
    ...
    def test_load(self):
        ...
        self.assertTrue(df_result.equals(df_exp))
    ...
    def test_etl_report1(self):
        ...
        # Expected results
        df_exp = self.df_report
        meta_exp = meta_exp = ['2021-04-17', '2021-04-18', '2021-04-19']
        # Test init
        extract_date = '2021-04-17'
        extract_date_list = ['2021-04-16', '2021-04-17', '2021-04-18', '2021-04-19']
        # Method execution
