...
class MetaProcess():
    ...
    def update_meta_file(extract_date_list: list, meta_key: str, s3_bucket_meta: S3BucketConnector):
        """
        Updating the meta file with the processed Xetra data dates and today's date as processed date

        :param : extract_date_list -> a list of dates of Xetra data that are extracted from the source
        ...
        try:
            ...
            df_all = df_new
        # writing to s3
        s3_bucket_meta.write_df_to_s3(data_frame=df_all, key=meta_key, file_format=MetaProcessFormat.META_FILE_FORMAT.value)
        return True
    ...
    def return_date_list(first_date: str, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        returns:
            ...
            return_date_list: list of all dates from min_date until today
        """
        # when I use staticmethod, DO NOT put "self" in the method argument
        # otherwise, it will not recognize a self.s3_bucket_meta during unit test
        ...
        try:
            ...
            if dates_missing:
                ...
                # return_min_date is the argument date
            ...
            # No meta file found -> creating a date list from the first date - 1 day until today
